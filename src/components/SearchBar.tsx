  ...
  return (
    <form onSubmit={handleSubmit} className="hidden lg:flex flex-1 max-w-md xl:max-w-xl mx-4 xl:mx-8 relative group">
      ...
      <input
        ...
        className="w-full bg-theme-tertiary hover:bg-theme-secondary border-2 border-transparent transition-all text-theme-primary rounded-full py-3 pl-12 pr-20 text-sm focus:outline-none focus:border-[#FF8543] placeholder:text-theme-muted shadow-inner"
      />
